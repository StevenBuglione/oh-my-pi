...
It does **not** cover TypeScript/JavaScript extension module loading (`extensions/*.ts`, `index.ts`, `package.json omg.extensions`), which is documented in `extension-loading.md`.
