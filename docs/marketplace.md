...
- **user** (default) -- available in all projects, stored in `~/.omg/plugins/installed_plugins.json`
- **project** -- available only in the current project, stored in `.omg/plugins/installed_plugins.json`
...
```
omg plugin marketplace add <source>
omg plugin marketplace remove <name>
omg plugin marketplace update [name]
omg plugin marketplace list
omg plugin discover [marketplace]
omg plugin install [--force] [--scope user|project] name@marketplace
omg plugin uninstall [--scope user|project] name@marketplace
omg plugin upgrade [--scope user|project] [name@marketplace]
```
