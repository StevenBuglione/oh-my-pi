...
- syntax highlighting colors used by native highlighter (`@oh-my-gpt/gpt-natives`)
...
- default: `~/.omg/agent/themes`
- overridden by `OMG_CODING_AGENT_DIR` (`$OMG_CODING_AGENT_DIR/themes`)
...
- default agent dir: `~/.omg/agent`
- effective default file: `~/.omg/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.omg/agent/themes/my-theme.json`.
