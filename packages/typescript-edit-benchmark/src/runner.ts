...
import type { AgentMessage, ResolvedThinkingLevel, ThinkingLevel } from "@oh-my-gpt/gpt-agent-core";
import type { Model } from "@oh-my-gpt/gpt-ai";
import { computeLineHash, formatSessionDumpText, RpcClient } from "@oh-my-gpt/gpt-coding-agent";
...
const CLI_PATH = Bun.fileURLToPath(import.meta.resolve("@oh-my-gpt/gpt-coding-agent/cli"));
...
interface BenchmarkClient {
	start(): Promise<void>;
	setThinkingLevel(level: import("@oh-my-gpt/gpt-agent-core").ResolvedThinkingLevel): Promise<void>;
