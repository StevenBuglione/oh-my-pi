...
import { getAgentDir, getSessionsDir, getStatsDbPath, setAgentDir, TempDir } from "@oh-my-gpt/gpt-utils";
...
const originalConfigDir = process.env.OMG_CONFIG_DIR;
...
beforeEach(() => {
	...
	process.env.OMG_CONFIG_DIR = configDir;
