...
import { formatDuration, formatNumber, formatPercent } from "@oh-my-gpt/gpt-utils";
...
async function main(): Promise<void> {
	...
	if (values.help) {
		console.log(`
omg-stats - AI Usage Statistics Dashboard
...
Examples:
  omg-stats              # Start dashboard server
  omg-stats --json       # Print stats as JSON
  omg-stats --port 8080  # Start on custom port
  omg-stats --sync       # Sync and show summary
`);
		return;
	}
