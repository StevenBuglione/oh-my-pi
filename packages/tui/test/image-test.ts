import { getImageDimensions, TERMINAL } from "@oh-my-gpt/gpt-tui";
import { Image } from "@oh-my-gpt/gpt-tui/components/image";
import { Spacer } from "@oh-my-gpt/gpt-tui/components/spacer";
import { Text } from "@oh-my-gpt/gpt-tui/components/text";
import { ProcessTerminal } from "@oh-my-gpt/gpt-tui/terminal";
import { TUI } from "@oh-my-gpt/gpt-tui/tui";
