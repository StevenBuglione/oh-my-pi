...
import { buildOpenAiNativeHistory, requestOpenAiRemoteCompaction } from "@oh-my-gpt/gpt-agent-core/compaction/openai";
import type { AssistantMessage, Model, ToolResultMessage } from "@oh-my-gpt/gpt-ai/types";
