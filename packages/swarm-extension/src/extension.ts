 ...
 * then use /swarm in any oh-my-gpt session.
 */

import * as fs from "node:fs/promises";
import * as path from "node:path";
import type { AuthStorage, ExtensionAPI, ExtensionCommandContext } from "@oh-my-gpt/gpt-coding-agent";
import { formatDuration } from "@oh-my-gpt/gpt-utils";
