/**
 * Swarm agent execution via oh-my-gpt's subagent infrastructure.
 *
...
import { runSubprocess } from "@oh-my-gpt/gpt-coding-agent";
...
/**
 * Execute a single swarm agent as an oh-my-gpt subagent.
 *
 * The agent receives:
