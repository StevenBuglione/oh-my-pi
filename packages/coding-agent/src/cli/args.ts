 ...
 */
import { type Effort, THINKING_EFFORTS } from "@oh-my-gpt/gpt-ai";
import { APP_NAME, CONFIG_DIR_NAME, logger } from "@oh-my-gpt/gpt-utils";
...
export function getExtraHelpText(): string {
  ...
  OMG_CODING_AGENT_DIR        - Session storage directory (default: ~/${CONFIG_DIR_NAME}/agent)
...
${chalk.bold("Useful Commands:")}
  omg agents unpack           - Export bundled subagents to ~/.omg/agent/agents (default)
  omg agents unpack --project - Export bundled subagents to ./.omg/agents`;
}
