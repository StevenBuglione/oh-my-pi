 ...
 *
 * Handles `omg setup <component>` to install dependencies for optional features.
 */
import * as path from "node:path";
import { $which, APP_NAME, getPythonEnvDir } from "@oh-my-gpt/gpt-utils";
import { $ } from "bun";
...
// package dependencies beyond a working interpreter. `omg setup python --check`
