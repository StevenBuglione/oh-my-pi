...
import type { CompactionPreparation, CompactionResult } from "@oh-my-gpt/gpt-agent-core/compaction";
import type { ImageContent, TextContent, ToolResultMessage } from "@oh-my-gpt/gpt-ai";
