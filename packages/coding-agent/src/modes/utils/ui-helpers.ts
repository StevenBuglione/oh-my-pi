...
import type { AssistantMessage, ImageContent, Message } from "@oh-my-gpt/gpt-ai";
import { type Component, Spacer, Text, TruncatedText } from "@oh-my-gpt/gpt-tui";
