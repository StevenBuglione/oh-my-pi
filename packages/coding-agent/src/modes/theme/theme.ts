...
import type { Effort } from "@oh-my-gpt/gpt-ai";
import {
...
import type { EditorTheme, MarkdownTheme, SelectListTheme, SymbolTheme } from "@oh-my-gpt/gpt-tui";
import { adjustHsv, getCustomThemesDir, isEnoent, logger } from "@oh-my-gpt/gpt-utils";
...
export function getSettingsListTheme(): import("@oh-my-gpt/gpt-tui").SettingsListTheme {
	return {
