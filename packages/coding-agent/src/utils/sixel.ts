import { $env, $flag } from "@oh-my-gpt/gpt-utils";
...
const SIXEL_PLACEHOLDER_PREFIX = "__OMG_SIXEL_SEQUENCE_";
...
export function sanitizeWithOptionalSixelPassthrough(text: string, sanitize: (text: string) => string): string {
	...
	return sanitized.replace(/__OMG_SIXEL_SEQUENCE_(\d+)__/gu, (_, indexText: string) => {
