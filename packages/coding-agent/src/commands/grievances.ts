...
export default class Grievances extends Command {
	...
	static args = {
		...
		// arg keeps the historical `omg grievances` invocation working unchanged
	...
	static examples = [
		"omg grievances",
		"omg grievances list --tool find",
		"omg grievances clean --id 209",
		"omg grievances clean --tool find",
		"omg grievances clean --all",
		"omg grievances push",
	];
