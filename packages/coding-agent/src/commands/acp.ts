/**
 * Run Oh My GPT as an ACP (Agent Client Protocol) server over stdio.
 *
 ...
 */
import { Command } from "@oh-my-gpt/gpt-utils/cli";
import { parseArgs } from "../cli/args";
import { runRootCommand } from "../main";
import { prepareAcpTerminalAuthArgs } from "../modes/acp/terminal-auth";

export default class Acp extends Command {
	static description = "Run Oh My GPT as an ACP (Agent Client Protocol) server over stdio";
	static strict = false;
