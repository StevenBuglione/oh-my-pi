...
import { glob, type SummaryResult, summarizeCode } from "@oh-my-gpt/gpt-natives";
import type { Component } from "@oh-my-gpt/gpt-tui";
import { Text } from "@oh-my-gpt/gpt-tui";
import { getRemoteDir, logger, prompt, readImageMetadata, untilAborted } from "@oh-my-gpt/gpt-utils";
...
export class ReadTool implements AgentTool<typeof readSchema, ReadToolDetails> {
	...
	async execute(
		...
		// Handle internal URLs (agent://, artifact://, memory://, skill://, rule://, local://, mcp://, omg://, issue://, pr://).
