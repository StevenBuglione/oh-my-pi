...
/**
 * Regression for https://github.com/can1357/oh-my-gpt/issues/1150
 *
 * In v15.1.3 `omg stats` crashed in the published Linux/macOS/Windows
 ...
 * the tab worker entry. Runtime coverage lives in `omg --smoke-test`,
