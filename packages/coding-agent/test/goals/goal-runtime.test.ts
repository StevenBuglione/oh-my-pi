...
} from "@oh-my-gpt/gpt-coding-agent/goals/runtime";
import type { Goal, GoalModeState, GoalRuntimeEvent, GoalTokenUsage } from "@oh-my-gpt/gpt-coding-agent/goals/state";
