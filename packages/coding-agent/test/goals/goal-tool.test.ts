...
import { completionBudgetReport, GoalRuntime } from "@oh-my-gpt/gpt-coding-agent/goals/runtime";
import type { Goal, GoalModeState, GoalTokenUsage } from "@oh-my-gpt/gpt-coding-agent/goals/state";
import { GoalTool } from "@oh-my-gpt/gpt-coding-agent/goals/tools/goal-tool";
