...
import { type Skill as CapabilitySkill, skillCapability } from "@oh-my-gpt/gpt-coding-agent/capability/skill";
import { getCapability } from "@oh-my-gpt/gpt-coding-agent/discovery";
import { loadSkills, loadSkillsFromDir, type Skill } from "@oh-my-gpt/gpt-coding-agent/extensibility/skills";
...
describe("skills", () => {
	...
	describe("loadSkills with options", () => {
		...
		it("should skip skills disabled via frontmatter", async () => {
			const tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "omg-disabled-skill-"));
