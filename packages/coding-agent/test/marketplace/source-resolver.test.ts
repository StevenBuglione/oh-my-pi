...
import type { MarketplacePluginEntry } from "@oh-my-gpt/gpt-coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@oh-my-gpt/gpt-coding-agent/extensibility/plugins/marketplace";
...
describe("resolvePluginSource", () => {
	...
	beforeEach(() => {
		tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "omg-src-res-test-"));
	});
