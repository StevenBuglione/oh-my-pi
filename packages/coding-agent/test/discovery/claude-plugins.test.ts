...
import { loadCapability } from "@oh-my-gpt/gpt-coding-agent/capability";
import { clearCache as clearFsCache } from "@oh-my-gpt/gpt-coding-agent/capability/fs";
import {
	clearClaudePluginRootsCache,
	listClaudePluginRoots,
	parseClaudePluginsRegistry,
} from "@oh-my-gpt/gpt-coding-agent/discovery/helpers";
import { discoverAgents } from "@oh-my-gpt/gpt-coding-agent/task/discovery";
import "@oh-my-gpt/gpt-coding-agent/discovery/claude-plugins";
import type { Skill } from "@oh-my-gpt/gpt-coding-agent/capability/skill";
import type { SlashCommand } from "@oh-my-gpt/gpt-coding-agent/capability/slash-command";
