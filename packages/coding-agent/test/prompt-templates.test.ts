...
import { expandPromptTemplate, type PromptTemplate } from "@oh-my-gpt/gpt-coding-agent/config/prompt-templates";
import { expandSlashCommand, type FileSlashCommand } from "@oh-my-gpt/gpt-coding-agent/extensibility/slash-commands";
import { parseCommandArgs, substituteArgs } from "@oh-my-gpt/gpt-coding-agent/utils/command-args";
