...
import { applyDisabledExtensionsToState } from "@oh-my-gpt/gpt-coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@oh-my-gpt/gpt-coding-agent/modes/components/extensions/types";
