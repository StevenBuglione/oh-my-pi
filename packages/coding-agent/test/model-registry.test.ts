...
import { Effort, type Model, type OpenAICompat, type ThinkingConfig, writeModelCache } from "@oh-my-gpt/gpt-ai";
import { kNoAuth, ModelRegistry } from "@oh-my-gpt/gpt-coding-agent/config/model-registry";
