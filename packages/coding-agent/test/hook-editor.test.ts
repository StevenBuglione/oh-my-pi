...
import { HookEditorComponent } from "@oh-my-gpt/gpt-coding-agent/modes/components/hook-editor";
import { ExtensionUiController } from "@oh-my-gpt/gpt-coding-agent/modes/controllers/extension-ui-controller";
