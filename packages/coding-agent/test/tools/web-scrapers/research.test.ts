...
import { handleBiorxiv } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/wikidata";
