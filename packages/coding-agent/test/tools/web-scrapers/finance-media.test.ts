...
import { handleArtifactHub } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/discogs";
