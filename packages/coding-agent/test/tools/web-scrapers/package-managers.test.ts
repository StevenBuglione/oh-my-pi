...
import { handleAur } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/aur";
import { handleBrew } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/brew";
import { handleMaven } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/rubygems";
