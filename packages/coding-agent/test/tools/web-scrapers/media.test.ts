...
import { handleHuggingFace } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/vimeo";
