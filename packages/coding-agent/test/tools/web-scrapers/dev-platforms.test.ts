...
import { handleDevTo } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/devto";
import { handleGitLab } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/lobsters";
