...
import { handleCheatSh } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/tldr";
