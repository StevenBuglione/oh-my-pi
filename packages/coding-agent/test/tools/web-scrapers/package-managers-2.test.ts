...
import { handleChocolatey } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@oh-my-gpt/gpt-coding-agent/web/scrapers/terraform";
