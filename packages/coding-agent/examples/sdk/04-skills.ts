 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@oh-my-gpt/gpt-coding-agent";

// Discover all skills from cwd/.omg/skills, ~/.omg/agent/skills, etc.
