 ...
 * - ~/.omg/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.omg/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.omg/agent/extensions/ or .omg/extensions/
