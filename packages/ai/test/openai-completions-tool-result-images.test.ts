...
import { convertMessages } from "@oh-my-gpt/gpt-ai/providers/openai-completions";
import type { AssistantMessage, Context, Model, OpenAICompat, ToolResultMessage, Usage } from "@oh-my-gpt/gpt-ai/types";
