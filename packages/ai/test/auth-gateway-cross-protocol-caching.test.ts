 ...
 *     → openai-responses parser → omg Context
 *     → gpt-ai anthropic provider (auto cache_control via cacheRetention)
...
const MODEL = Bun.env.OMG_E2E_ANTHROPIC_MODEL ?? "claude-sonnet-4-5";
