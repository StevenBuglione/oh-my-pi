...
import { detectOpenAICompat, resolveOpenAICompat } from "@oh-my-gpt/gpt-ai/providers/openai-completions-compat";
import type { Context, Model, Tool } from "@oh-my-gpt/gpt-ai/types";
