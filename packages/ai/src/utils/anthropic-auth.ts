 ...
 *   3. OAuth credentials in ~/.omg/agent/agent.db (with expiry check)
 *   4. API key credentials in ~/.omg/agent/agent.db
 *   5. Generic Anthropic fallback (ANTHROPIC_API_KEY / ANTHROPIC_BASE_URL)
 */
import { $env, getAgentDbPath } from "@oh-my-gpt/gpt-utils";
