...
```bash
npm install @oh-my-gpt/gpt-ai
```

## Quick Start

```typescript
import { z, getModel, stream, complete, Context, Tool } from "@oh-my-gpt/gpt-ai";
...
```typescript
import { z, Tool } from "@oh-my-gpt/gpt-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@oh-my-gpt/gpt-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@oh-my-gpt/gpt-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@oh-my-gpt/gpt-ai";
...
```typescript
import { getModel, stream } from "@oh-my-gpt/gpt-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@oh-my-gpt/gpt-ai";
...
```typescript
import { Model, stream } from "@oh-my-gpt/gpt-ai";
...
```typescript
import { getModel, complete, Context } from "@oh-my-gpt/gpt-ai";
...
```typescript
import { Context, getModel, complete } from "@oh-my-gpt/gpt-ai";
...
```typescript
import { getEnvApiKey } from "@oh-my-gpt/gpt-ai";
...
```bash
bunx @oh-my-gpt/gpt-ai login              # interactive provider selection
bunx @oh-my-gpt/gpt-ai login anthropic    # login to specific provider
bunx @oh-my-gpt/gpt-ai login vllm         # store vLLM API key (or placeholder for local no-auth)
bunx @oh-my-gpt/gpt-ai list               # list available providers
```
...
```typescript
import { loginGitHubCopilot } from "@oh-my-gpt/gpt-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@oh-my-gpt/gpt-ai";
import * as fs from "node:fs";
